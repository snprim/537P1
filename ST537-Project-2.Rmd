...
g<- ggplot(data = Data2Summary, mapping = aes(x = nObs, color = Drug)) + 
  geom_histogram(bins = 8, fill = 'white', position = 'stack' ) + facet_grid(Drug~Time_Point)
g
...
There are four time points; time zero was collected before any procedure was done. Times 1,2, and 3 were collected two weeks after an initial and two booster vaccine shots were administered to the macaques. In the treatment groups, groups 1-3 represent different doses of anti T-Reg drug 1, groups 4-6 represent different doses of anti-Treg drug 2, and group 7 represents the control group. 
